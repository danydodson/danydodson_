...
//           src={`data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 ${(100 * aspectRatio).toFixed(2)}'%3E%3C/svg%3E`}
//         />
//         <iframe src={src} allowFullScreen frameBorder={0} title='embed' />
//       </div>
//       {caption ? <figcaption>{caption}</figcaption> : null}
//     </div>
//   )
